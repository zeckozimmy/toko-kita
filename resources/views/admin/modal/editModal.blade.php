                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <select type="text" class="form-control" id="type" name="type">
                                ...
                                <option value="helm half-face" {{ $data->type === 'helm half-face' ? 'selected' : '' }}>helm half-face</option>
                                <option value="helm full-face" {{ $data->type === 'helm full-face' ? 'selected' : '' }}>helm full-face</option>
